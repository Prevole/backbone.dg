(function() {
  ...
  Backbone.Ajadmin.Dg = window.Ajadmin.Dg = (function(Backbone, Marionette, _, $) {
    var Dg, EmptyView, LoadingView, defaults, gridRegions, i18nKeys, infoKeys, reject;
    Dg = Ajadmin.Dg = {
      version: "0.0.1"
    };
    ...
    Dg.InfoView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/info";
    ...
    Dg.QuickSearchView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/quicksearch";
    ...
    Dg.PerPageView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/perpage";
    ...
    Dg.ToolbarView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/toolbar";
    ...
    Dg.PagerView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/pager";
    ...
    Dg.RowView = (function(_super) {
      ...
      _Class.vent.trigger("row:delete", _Class.model);
    ...
    EmptyView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/empty";
    ...
    LoadingView = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/gridempty";
    ...
    Dg.GridLayout = (function(_super) {
      ...
      _Class.prototype.template = "layouts/dg/grid";
      ...
      _Class.prototype.renderRegions = function() {
        ...
        this.table.show(new DefaultGridEmptyView());
