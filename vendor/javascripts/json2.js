...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>tableling/vendor/json2.js at master · AlphaHydrae/tableling</title>
...
<meta content="ADLqNZnewDw6QzRenX4PYk8UOYx0SGysdxgWZqi3zWE=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/assets/github-91075f957a1f33e3f4fb4ee831540fc563718237.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/AlphaHydrae/tableling/blob/c22b7115305680c005b19e13ea23b9f711512eac/vendor/json2.js'>
          ...
          <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
            <div class="no-results js-not-filterable">Nothing to show</div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                <span class="mini-icon mini-icon-confirm"></span>
                <h4>
                    <a href="/AlphaHydrae/tableling/blob/develop/vendor/json2.js" class="js-navigation-open" data-name="develop" rel="nofollow">develop</a>
                </h4>
              </div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                <span class="mini-icon mini-icon-confirm"></span>
                <h4>
                    <a href="/AlphaHydrae/tableling/blob/gh-pages/vendor/json2.js" class="js-navigation-open" data-name="gh-pages" rel="nofollow">gh-pages</a>
                </h4>
              </div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target selected">
                <span class="mini-icon mini-icon-confirm"></span>
                <h4>
                    <a href="/AlphaHydrae/tableling/blob/master/vendor/json2.js" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
          </div>
            ...
            <div class="js-filter-tab js-filter-tags " style="display:none" data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
              <div class="no-results js-not-filterable">Nothing to show</div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/AlphaHydrae/tableling/blob/0.0.8/vendor/json2.js" class="js-navigation-open" data-name="0.0.8" rel="nofollow">0.0.8</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/AlphaHydrae/tableling/blob/0.0.7/vendor/json2.js" class="js-navigation-open" data-name="0.0.7" rel="nofollow">0.0.7</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/AlphaHydrae/tableling/blob/0.0.6/vendor/json2.js" class="js-navigation-open" data-name="0.0.6" rel="nofollow">0.0.6</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/AlphaHydrae/tableling/blob/0.0.5/vendor/json2.js" class="js-navigation-open" data-name="0.0.5" rel="nofollow">0.0.5</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/AlphaHydrae/tableling/blob/0.0.4/vendor/json2.js" class="js-navigation-open" data-name="0.0.4" rel="nofollow">0.0.4</a>
                  </h4>
                </div>
            </div>
        </div>
...
<!-- blob contrib key: blob_contributors:v21:0405c4d9f85d91aed16ce21577adb4e0 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:0405c4d9f85d91aed16ce21577adb4e0 -->

<div id="slider">

    <div class="breadcrumb" data-path="vendor/json2.js/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/AlphaHydrae/tableling" itemscope="url"><span itemprop="title">tableling</span></a></b> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/AlphaHydrae/tableling/tree/master/vendor" itemscope="url"><span itemprop="title">vendor</span></a></span> / <strong class="final-path">json2.js</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="vendor/json2.js" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>

      <div class="commit commit-loader file-history-tease js-deferred-content" data-url="/AlphaHydrae/tableling/contributors/master/vendor/json2.js" data-path="vendor/json2.js/">
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="vendor/json2.js/" data-permalink-url="/AlphaHydrae/tableling/blob/c22b7115305680c005b19e13ea23b9f711512eac/vendor/json2.js" data-title="tableling/vendor/json2.js at master · AlphaHydrae/tableling · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter" href="/AlphaHydrae/tableling/edit/master/vendor/json2.js" data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
                  </li>
                <li>
                  <a href="/AlphaHydrae/tableling/raw/master/vendor/json2.js" class="minibutton grouped-button bigger lighter" id="raw-url">Raw</a>
                </li>
                  <li>
                    <a href="/AlphaHydrae/tableling/blame/master/vendor/json2.js" class="minibutton grouped-button bigger lighter">Blame</a>
                  </li>
                <li>
                  <a href="/AlphaHydrae/tableling/commits/master/vendor/json2.js" class="minibutton grouped-button bigger lighter" rel="nofollow">History</a>
                </li>
              </ul>
            </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    <div id="legal">
      ...
      <p>&copy; 2012 <span title="0.18078s from fe17.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.18246' data-host='fe17'></span>
